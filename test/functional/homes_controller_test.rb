...
class HomesControllerTest < ActionController::TestCase
  ...
  test "should create home" do
    assert_difference('Home.count') do
      post :create, home: { description: @home.description, picture: @home.picture, title: @home.title }
    end
  ...
  test "should update home" do
    put :update, id: @home, home: { description: @home.description, picture: @home.picture, title: @home.title }
    assert_redirected_to home_path(assigns(:home))
  end
